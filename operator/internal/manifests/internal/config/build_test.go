...
# (See https://github.com/pao214/loki/v3/blob/main/production/ksonnet/loki/config.libsonnet)
limits_config:
  ...
  # (See https://github.com/pao214/loki/v3/blob/main/pkg/ingester/limiter.go#L73)
